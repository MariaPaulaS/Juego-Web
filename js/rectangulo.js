...
Rectangulo.prototype.insertarDOM = function(){
    ...
    var color = '#' + Math.floor(Math.random() * 1677215).toString(16);
    ...
    document.getElementById(this.id).style.width = this.alto + "px";
    document.getElementById(this.id).style.height = this.ancho + "px";
